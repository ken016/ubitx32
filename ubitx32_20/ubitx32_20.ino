...
void panelHTML() {
 ...
 // writeMenu(1, auxI);
  ...
  printP(tr,td,"Calibration",td_f,td); printI(conf.calibration); printP(td_f, tr_f);
  printP(tr,td,"usbCarrier",td_f,td); printI(conf.usbCarrier); printP(td_f, tr_f);
