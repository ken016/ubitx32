...
void Check_Cat(byte fromType)
{
  ...
  switch(CAT_BUFF[4])
    ...
    case 0x03 : CatGetFreqMode(conf.frequency); break;  //Read Frequency and mode
    case 0x07 : CatSetMode(CAT_BUFF[0], fromType); break;  //Set Operating  Mode
    case 0x08 : //Set PTT_ON
    case 0x88 : CatSetPTT(CAT_BUFF[4] == 0x08, fromType); break; //Set PTT Off
